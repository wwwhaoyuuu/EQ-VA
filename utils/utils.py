...
def build_dataset(datasets: list, valances: list, stage: str = "train"):
    shock_dataset_list = []
    ch_names_list = []
    start_sub = 0
    for dataset_list, valance_list in zip(datasets, valances):
        dataset = ShockDataset(dataset_list, valance_list, stage, start_sub)
...
def get_metrics(output, target, metrics):
    ...
    if "balanced_accuracy" in metrics:
        ...
        class_acc = [
            class_correct[cls.item()] / class_total[cls.item()]
