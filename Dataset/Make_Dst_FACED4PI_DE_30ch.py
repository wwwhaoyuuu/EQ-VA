...
if __name__ == '__main__':
    ...
    os.makedirs(f'/data/0shared/jinjiarui/run/PI/Dataset/FACED_PI/window{de_window_size}_step{step}_ch30',
                exist_ok=True)
    for valance in train_data.keys():
        np.save(f'/data/0shared/jinjiarui/run/PI/Dataset/FACED_PI/window{de_window_size}_step{step}_ch30'
                f'/{valance}_train_data.npy', train_data[valance])
        np.save(
                f'/data/0shared/jinjiarui/run/PI/Dataset/FACED_PI/window{de_window_size}_step{step}_ch30/{valance}_train_label.npy',
                train_label[valance])
        np.save(
                f'/data/0shared/jinjiarui/run/PI/Dataset/FACED_PI/window{de_window_size}_step{step}_ch30/{valance}_eval_data.npy',
                eval_data[valance])
        np.save(
                f'/data/0shared/jinjiarui/run/PI/Dataset/FACED_PI/window{de_window_size}_step{step}_ch30/{valance}_eval_label.npy',
                eval_label[valance])

    channel_names = ['FP1', 'FP2', 'FZ', 'F3', 'F4', 'F7', 'F8', 'FC1',
                     'FC2', 'FC5', 'FC6', 'CZ', 'C3', 'C4', 'T7', 'T8',
                     'CP1', 'CP2', 'CP5', 'CP6', 'PZ', 'P3', 'P4', 'P7',
                     'P8', 'PO3', 'PO4', 'OZ', 'O1', 'O2', ]
    np.save(
            f'/data/0shared/jinjiarui/run/PI/Dataset/FACED_PI/window{de_window_size}_step{step}_ch30/channel_names.npy',
            channel_names)
