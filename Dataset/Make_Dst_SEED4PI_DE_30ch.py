...
if __name__ == '__main__':
    ...
    # 保存一下数据
    os.makedirs(f'/data/0shared/jinjiarui/run/PI/Dataset/SEED_PI/window{de_window_size}_step{step}_ch{num_channels}',
                exist_ok=True)
    for emo in train_data.keys():
        np.save(
                f'/data/0shared/jinjiarui/run/PI/Dataset/SEED_PI/window{de_window_size}_step{step}_ch{num_channels}/{emo}_train_data.npy',
                train_data[emo])
        np.save(
                f'/data/0shared/jinjiarui/run/PI/Dataset/SEED_PI/window{de_window_size}_step{step}_ch{num_channels}/{emo}_eval_data.npy',
                eval_data[emo])
        np.save(
                f'/data/0shared/jinjiarui/run/PI/Dataset/SEED_PI/window{de_window_size}_step{step}_ch{num_channels}/{emo}_train_label.npy',
                train_label[emo])
        np.save(
                f'/data/0shared/jinjiarui/run/PI/Dataset/SEED_PI/window{de_window_size}_step{step}_ch{num_channels}/{emo}_eval_label.npy',
                eval_label[emo])
    ...
    np.save(
            f'/data/0shared/jinjiarui/run/PI/Dataset/SEED_PI/window{de_window_size}_step{step}_ch{num_channels}/channel_names.npy',
            channel_names)
