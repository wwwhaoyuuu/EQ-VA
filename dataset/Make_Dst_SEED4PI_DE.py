...
if __name__ == "__main__":
    data_folder_path = "./dataset/SEED_select"
    ...
    os.makedirs(f"./dataset/SEED_PI/window{de_window_size}_step{step}", exist_ok=True)
    for emo in train_data.keys():
        np.save(
            f"./dataset/SEED_PI/window{de_window_size}_step{step}/{emo}_train_data.npy",
            train_data[emo],
        )
        np.save(
            f"./dataset/SEED_PI/window{de_window_size}_step{step}/{emo}_eval_data.npy",
            eval_data[emo],
        )
        np.save(
            f"./dataset/SEED_PI/window{de_window_size}_step{step}/{emo}_train_label.npy",
            train_label[emo],
        )
        np.save(
            f"./dataset/SEED_PI/window{de_window_size}_step{step}/{emo}_eval_label.npy",
            eval_label[emo],
        )
        print(
            emo,
    ...
    np.save(
        f"./dataset/SEED_PI/window{de_window_size}_step{step}/channel_names.npy",
        channel_names,
    )
