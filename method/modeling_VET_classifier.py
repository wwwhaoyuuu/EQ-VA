...
def get_model_default_params():
    return dict(
        feature_dim=32, embed_dim=256, depth=12, heads=10, mlp_dim=2048, dim_head=64, dropout=0.01, emb_dropout=0.01
    )
...
if __name__ == '__main__':
    model = VAT_classifier(num_classes=138,feature_dim=4)
