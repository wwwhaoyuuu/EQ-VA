...
from model.MDCA_Encoder import MDCAEncoder
...
def get_model_default_params():
    return dict(
            input_size=(1, 5), patch_size=(1, 1), num_classes=138, dim=256, depth=8, heads=2, mlp_dim=256, channels=62,
...
def MDCAT_classifier(pretrained=False, **kwargs):
    ...
    config["depth"] = 4
    config["heads"] = 2
    print("MDCAT classifier parameters:", config)
    model = MD_CAT(**config)
